    ...
    <section className="py-20 bg-forest-100/60">
      <div className="max-w-3xl mx-auto px-6 text-center">
        ...
        <p className="text-forest-800 text-lg md:text-xl mb-6">
          Hotel Hrádok ponúka <span className="font-bold text-forest-900">12 izieb</span> s celkovou kapacitou <span className="font-bold text-forest-900">39 lôžok</span> a <span className="font-bold text-forest-900">4 prístelky</span>.
        </p>
        <div className="flex flex-col sm:flex-row justify-center gap-8 mt-8">
          ...
          <div className="bg-white rounded-2xl shadow p-8 flex-1">
            <div className="text-5xl font-serif font-bold text-forest-900 mb-2">39</div>
            <div className="text-xs uppercase tracking-widest text-forest-600">Lôžok</div>
          </div>
          <div className="bg-white rounded-2xl shadow p-8 flex-1">
            <div className="text-5xl font-serif font-bold text-forest-900 mb-2">4</div>
