  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="bar, hotel hrádok, občerstvenie, posedenie, oslavy, večerné akcie, hotel Malá Fatra, hotel Bystrička, hotel pre skupiny, hotel pre oslavy" />
      </Helmet>
