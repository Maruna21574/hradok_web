    ...
    <main>
      <section>
        <div className="max-w-3xl mx-auto py-24 px-6">
          <Helmet>
            <title>GDPR – Ochrana osobných údajov | Hotel Hrádok</title>
            <meta name="description" content="Informácie o spracovaní a ochrane osobných údajov podľa GDPR v hoteli Hrádok. Vaše práva, účel spracúvania, kontaktné údaje." />
            <meta name="keywords" content="GDPR, ochrana osobných údajov, hotel hrádok, súkromie, práva, spracovanie údajov, Slovensko" />
          </Helmet>
