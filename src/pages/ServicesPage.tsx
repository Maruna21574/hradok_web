...
const ServicesPage = () => {
  return (
    <>
      <Helmet>
        <title>Služby – Hotel Hrádok</title>
        <meta name="description" content="Služby hotela Hrádok: exkluzívny prenájom, vináreň, catering, firemné akcie, svadby, komfort a súkromie v prírode." />
        <meta name="keywords" content="hotel hrádok, služby, vináreň, catering, firemné akcie, svadby, komfort, súkromie, event, prenájom, Turiec, Malá Fatra" />
        <meta property="og:title" content="Služby – Hotel Hrádok" />
        ...
        <meta name="twitter:description" content="Služby hotela Hrádok: exkluzívny prenájom, vináreň, catering, firemné akcie, svadby, komfort a súkromie v prírode." />
        ...
        <section className="py-24 bg-forest-50">
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <article>
                <span className="text-forest-600 font-bold uppercase tracking-widest text-xs mb-4 block">
                  čo ponúkame
                </span>
                ...
                <div className="flex flex-wrap gap-8">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <span className="font-bold text-forest-900 text-sm uppercase tracking-widest">Gastronómia</span>
                  </div>
                  <div className="flex flex-col gap-2">
                    <div className="w-12 h-12 rounded-2xl bg-white flex items-center justify-center text-forest-600 shadow-sm">
                      <Wine className="w-6 h-6" />
                    </div>
                    <span className="font-bold text-forest-900 text-sm uppercase tracking-widest">Vináreň</span>
                  </div>
                  <div className="flex flex-col gap-2">
                    <div className="w-12 h-12 rounded-2xl bg-white flex items-center justify-center text-forest-600 shadow-sm">
                      <Flame className="w-6 h-6" />
                    </div>
                    <span className="font-bold text-forest-900 text-sm uppercase tracking-widest">Grilovačky</span>
                  </div>
                  <div className="flex flex-col gap-2">
                    <div className="w-12 h-12 rounded-2xl bg-white flex items-center justify-center text-forest-600 shadow-sm">
                      <Coffee className="w-6 h-6" />
                    </div>
                    <span className="font-bold text-forest-900 text-sm uppercase tracking-widest">Coffee breaky</span>
                  </div>
                </div>
              </article>
