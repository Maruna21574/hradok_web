...
const LocationPage = () => {
  return (
    <>
      <Helmet>
        <title>Hotel Hrádok – Lokalita a okolie</title>
        <meta name="description" content="Kde sa nachádza Hotel Hrádok? Pozrite si polohu, tipy na výlety a možnosti v okolí Bystričky a Malej Fatry." />
        <meta name="keywords" content="hotel hrádok, lokalita, poloha, Bystrička, Malá Fatra, výlety, okolie, mapa, turistika, relax" />
      </Helmet>
      <header>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid lg:grid-cols-3 gap-8 mb-16">
              {[
                ...
                <article key={idx} className="bg-white p-10 rounded-3xl shadow-sm border border-forest-100">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                <article key={i} className="p-8 bg-forest-50 rounded-3xl border border-forest-100 shadow-md flex flex-col items-center text-center hover:bg-forest-100 transition-all">
                  {tip.icon}
