...
const BookingPage = () => {
  ...
  if (submitted) {
    return (
      <main className="pt-24 min-h-screen flex items-center justify-center bg-forest-50 px-6">
        <motion.div 
        ...
        <section className="section-padding bg-forest-50">
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-16">
              ...
              <aside className="bg-white p-10 rounded-3xl shadow-xl border border-forest-100 h-fit">
